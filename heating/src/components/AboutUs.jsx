    ...
    return (
        <>
            ...
            <div style={{
                ...
                {/* Hero Section - Standardized 2-Column */}
                <div style={{
                    ...
                    <style>{`
                        @media (max-width: 968px) {
                            ...
                            .about-hero-img { order: -1; margin-bottom: 20px; }
                        }
                    `}</style>
                    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="about-hero-grid">
                        <div>
                            <div style={{
                            ...
                            <h1 style={{
                                ...
                                Heating & Cooling Experts <span style={{ color: dark }}>You Can Trust.</span>
                            </h1>
