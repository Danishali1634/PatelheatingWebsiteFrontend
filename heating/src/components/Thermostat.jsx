...
export default function Thermostat() {
    return (
        <>
            <Helmet>
                <title>Smart Thermostat Installation Brampton | Remote HVAC Control</title>
                <meta name="description" content="Upgrade to a smart thermostat for better energy savings and remote HVAC control. Professional installation of Nest, Ecobee, and more in Brampton." />
                <meta name="keywords" content="smart thermostat Brampton, Nest installation, Ecobee thermostat service, HVAC controls Brampton, Patel Heating" />
            </Helmet>
            <div style={{ fontFamily: "Inter, sans-serif", color: "#0d0d0d" }}>
                ...
                <div style={{
                    ...
                    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center", position: "relative", zIndex: 1 }} className="thermostat-hero-grid">
                        <style>{`
                            @media (max-width: 968px) {
                                .thermostat-hero-grid { grid-template-columns: 1fr !important; text-align: center; }
                                .thermostat-hero-img { order: -1; margin-bottom: 20px; }
                            }
                        `}</style>
                        <div>
                            <div style={{
                                ...
                                <Wifi size={16} fill="#ff7216" color="#ff7216" /> SMART HOME READY
                            </div>
                            <h1 style={{
                                fontSize: "clamp(48px, 6vw, 76px)", fontWeight: 900, lineHeight: 1.1, marginBottom: 24,
                                letterSpacing: "-0.03em", color: "#0c4a6e"
                            }}>
                                Control <span style={{ color: "#ff7216" }}> Your </span>Comfort<br />
                                <span style={{ color: "#ff7216" }}>From Anywhere.</span>
                            </h1>
                            ...
                            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                                <Link to="/contact" style={{
                                    ...
                                    Install Smart Device <ArrowRight size={20} />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="thermostat-hero-img" style={{ position: "relative" }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                                    <div style={{ color: "#ff7216" }}><PieChart size={20} /></div>
                                    <div style={{ fontWeight: 700, fontSize: 14, color: "#1e293b" }}>Energy Savings</div>
                                </div>
                                <p style={{ fontSize: 13, color: "#64748b", margin: 0, lineHeight: 1.4 }}>
                                    Reduce bills by up to 15% with smart scheduling.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {/* Secondary Section */}
                <div style={{ padding: "100px 20px", background: "#f1f5f9" }}>
                    <div style={{
                        ...
                        <div style={{ padding: "80px 60px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                            ...
                            <h2 style={{ fontSize: "clamp(32px, 5vw, 42px)", fontWeight: 900, marginBottom: 32, lineHeight: 1.1, color: "#0f172a" }}>
                                Precision Control <br /> At Your Fingertips
                            </h2>
                            <p style={{ fontSize: 18, color: "#44403c", lineHeight: 1.7, marginBottom: 40, maxWidth: 500 }}>
                                Your thermostat is the brain of your HVAC system. A smart upgrade gives you complete control from anywhere in the world.
                            </p>

                            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 24 }}>
                                {[
                                    { title: "Remote Access", desc: "Change settings from your smartphone or tablet anywhere." },
                                    { title: "Energy Reports", desc: "Detailed insights into your usage to help you save more." },
                                    { title: "Smart Scheduling", desc: "Learns your routine to automatically optimize comfort." }
                                ].map((item, i) => (
                                    <li key={i} style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
                                        <div style={{ width: 44, height: 44, borderRadius: 12, background: "rgba(255, 114, 22, 0.08)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                                            <Wifi size={22} color="#ff7216" />
                                        </div>
                                        <div>
                                            <h4 style={{ fontSize: 18, fontWeight: 700, color: "#0f172a", marginBottom: 6 }}>{item.title}</h4>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", borderLeft: "1px solid #f1f5f9" }}>
                            <div style={{ flex: 1, position: "relative", minHeight: "50vh", maxHeight: "50vh", overflow: "hidden", background: "#f8fafc" }}>
                                ...
                                <div style={{
                                    ...
                                    <h4 style={{ fontSize: 28, fontWeight: 800, marginBottom: 12, color: "#ff7216" }}>Total Command</h4>
                                    <p style={{ opacity: 0.9, color: "#ff7216", fontWeight: 600, fontSize: 16 }}>The ultimate interface for your home's comfort.</p>
                                </div>
                            </div>
                            ...
                            <div style={{ padding: "40px 60px", background: "#fff", borderTop: "1px solid #f1f5f9", display: "flex", flexDirection: "column", gap: 20 }}>
                                <div>
                                    <span style={{ fontSize: 13, textTransform: "uppercase", letterSpacing: 1.5, fontWeight: 700, color: "#94a3b8" }}>Featured Device</span>
                                    <h3 style={{ fontSize: 24, fontWeight: 800, color: "#ff7216", margin: "8px 0 0" }}>Ecobee Smart Thermostat</h3>
                                </div>
                                <div style={{
                                    ...
                                    <span style={{ fontSize: 15, fontWeight: 700, color: "#475569" }}>Smart Home Integrated</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div style={{ padding: "60px 20px", background: "#fff", textAlign: "center" }}>
                    <div style={{ maxWidth: 800, margin: "0 auto" }}>
                        <h2 style={{ fontSize: "36px", fontWeight: 800, marginBottom: 24, color: '#ff7216' }}>Ready to optimize your comfort?</h2>
                        <p style={{ fontSize: 18, color: "#64748b", marginBottom: 40 }}>Our team can help you select and install the perfect smart thermostat for your home.</p>
                        <Link to="/contact" style={{
